...
processed_image = Image.open("test_outputs_august8/test_differenced3.png")
processed_image = general.PIL_to_scikit_or_openCV(processed_image)
processed_image = scikit.edge_detection_meijering(processed_image)
scikit.save_images("test_outputs_august8/", "edged1.png", processed_image)
